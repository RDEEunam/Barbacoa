...
<div class="box box-primary col-xs-12">
    <div class="box-header">
        <h3 class="box-title">Editar una comida</h3>
    </div>
<!-- /.box-header -->
    <div id="notificacion_resul_fanu"></div>

		<!-- comienzo del formulario -->
		<form id="MasComidaEditar" method="post" action="{{Action('MasComidaController@update', $id)}}" enctype="multipart/form-data" >
		...
		<div class="box-body col-xs-12">
			<div class="form-group col-xs-6">
				<label>
				    ...
				    <select id="sel" name="Nombre" class="form-control">
					    <option value="{{$MasComidas->Nombre}}">{{$MasComidas->Nombre}}</option>
			...
			<div class="form-group col-xs-12">
				<label>
				    ...
				    <select id="sel2" name="Sabor" class="form-control">
					    <option value="{{$MasComidas->Sabor}}">{{$MasComidas->Sabor}}</option>
			...
			<div class="form-group col-xs-12">
				<label>
				    ...
				    <textarea class="form-group col-xs-12" type="text" name="Descripcion" placeholder=" " required="" value="{{$MasComidas->Descripcion}}"/></textarea>
			</div>
			<!-- seccion de mensaje-->
			<div class="form-group col-xs-6">
				<label>
					<i class="fa fa-pencil" aria-hidden="true"></i>Precio:</label>
				    <input class="form-group col-xs-12" type="text" name="Precio" class="validanumericos" autocomplete="off" placeholder=" " required=""value="{{$MasComidas->Precio}}"/>
			</div>
			<div class="form-group col-xs-6"> 
			    <label>
